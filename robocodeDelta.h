...
#ifndef robocodeDelta_t
#define robocodeDelta_t
...
class robocodeDelta: public grammarBase {
public:
...
protected:
	robocodeDelta(); //Constructor
private:
	static robocodeDelta* _instance;
...
namespace robocodeDelta_namespace {
