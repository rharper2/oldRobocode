...
#ifndef robocodeBeta_t
#define robocodeBeta_t
...
protected:
	robocodeBeta(); //Constructor
private:
	static robocodeBeta* _instance;
...
namespace robocodeBeta_namespace {
