...
public class RoboRunnerViewer {
	...
	public static void main(String[] args) throws IOException {
		...
		engine.addBattleListener(new ViewerBattleObserver(out));

		String inputLine,outputLine;
		out.println("Next");
		System.out.println("Wrote next");
...
class ViewerBattleObserver extends BattleAdaptor {
	PrintWriter out;
	
	ViewerBattleObserver(PrintWriter theWriter) {
		out = theWriter;
	}
