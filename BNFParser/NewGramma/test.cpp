...
bool test::doACreate(int *exp,int *length,int maxExp,long codon_list[],
...
bool test::ptc2Grow(int *exp, int *length, int maxExp, long codon_list[],
...
void test::ptc2GrowOne(bool allowExpand) {
...
bool test::traverseParseTree(parseTreePtr cNode) {
...
void test::AllowFunctions(bool al) {
          allowFunctions = al;
          if (al) cout << "Functions are allowed.\n";
          else cout << "Functions are prohibited\n";
}

bool test::parse(int *exp,int *length,
...
bool test::dealtWithPop(int expr[],int *curr,int *length) {
...
void test::changeCodonsForGrow(int divisors) {
...
void test::apply_one_grammar(int curr_expr[],int *curr,int *length)
{
...
/***************************************************************/
void test::print_grammar_individual(ostream& output_stream,int curr_expr[],int length){
