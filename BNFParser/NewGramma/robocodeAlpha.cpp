			...
			switch(currentCodon%divisor){
				default:{ // We are going to call a function
					...
					*length = *length+shift;
					...
					if (fPars > 0) {
						curr_expr[*curr+2]=FPARS; // FPARS = 106
						for (int j=0;j<fPars-1;j++) {
							curr_expr[*curr+3+2*j]=COMMA; // , = 0
							curr_expr[*curr+4+2*j]=FPARS; // FPARS = 106
						}
					}
...
/***************************************************************/
void robocodeAlpha::print_grammar_individual(ostream& output_stream,int curr_expr[],int length){
	for(int i=0;i<length;i++)
		...
		case IMPORT: {output_stream << " import ";break;}
		case ROBOCODEDOTSTAR: {output_stream << " robocodeDOTSTAR ";break;}
		case N: {output_stream << " N ";break;}
		...
		case RUN__: {output_stream << " run__ ";break;}
		case WHILE: {output_stream << " while ";break;}
		case TRUE_: {output_stream << " true_ ";break;}
		case ONSCANNEDROBOT_SCANNEDROBOTEVENT: {output_stream << " onScannedRobot_ScannedRobotEvent ";break;}
		case E_CB: {output_stream << " e_CB ";break;}
		case ONHITBYBULLET_HITBYBULLETEVENT: {output_stream << " onHitByBullet_HitByBulletEvent ";break;}
		case ONHITROBOT_HITROBOTEVENT: {output_stream << " onHitRobot_HitRobotEvent ";break;}
		case ONHITWALL_HITWALLEVENT: {output_stream << " onHitWall_HitWallEvent ";break;}
		case IF: {output_stream << " if ";break;}
		case ELSE: {output_stream << " else ";break;}
		case TURNRIGHT_OB: {output_stream << " turnRight_OB ";break;}
		case TURNLEFT_OB: {output_stream << " turnLeft_OB ";break;}
		case TURNGUNRIGHT_OB: {output_stream << " turnGunRight_OB ";break;}
		case TURNGUNLEFT_OB: {output_stream << " turnGunLeft_OB ";break;}
		case TURNRADARRIGHT_OB: {output_stream << " turnRadarRight_OB ";break;}
		case TURNRADARLEFT_OB: {output_stream << " turnRadarLeft_OB ";break;}
		case AHEAD_OB: {output_stream << " ahead_OB ";break;}
		case BACK_OB: {output_stream << " back_OB ";break;}
		case RESUME__: {output_stream << " resume__ ";break;}
		case STOP__: {output_stream << " stop__ ";break;}
		case SETADJUSTGUNFORROBOTTURN_OB: {output_stream << " setAdjustGunForRobotTurn_OB ";break;}
		case SETADJUSTRADARFORROBOTTURN_OB: {output_stream << " setAdjustRadarForRobotTurn_OB ";break;}
		case SETADJUSTRADARFORGUNTURN_OB: {output_stream << " setAdjustRadarForGunTurn_OB ";break;}
		case FIRE_1: {output_stream << " fire_1 ";break;}
		case FIRE_2: {output_stream << " fire_2 ";break;}
		case FIRE_3: {output_stream << " fire_3 ";break;}
		case FIRE_4: {output_stream << " fire_4 ";break;}
		case PDIV_OB: {output_stream << " PDIV_OB ";break;}
		case NOT_OB: {output_stream << " NOT_OB ";break;}
		case AND: {output_stream << " AND ";break;}
		case XOR: {output_stream << " XOR ";break;}
		case OR: {output_stream << " OR ";break;}
		case AHEAD_: {output_stream << " ahead_ ";break;}
		case BACK_: {output_stream << " back_ ";break;}
		case PDIV_: {output_stream << " PDIV_ ";break;}
		case NOT_: {output_stream << " NOT_ ";break;}
		case GETX__: {output_stream << " getX__ ";break;}
		case GETY__: {output_stream << " getY__ ";break;}
		case GETHEADING__: {output_stream << " getHeading__ ";break;}
		case GETGUNHEADING__: {output_stream << " getGunHeading__ ";break;}
		case GETGUNHEAT__: {output_stream << " getGunHeat__ ";break;}
		case GETRADARHEADING__: {output_stream << " getRadarHeading__ ";break;}
		case GETBATTLEFIELDWIDTH__: {output_stream << " getBattleFieldWidth__ ";break;}
		case GETENERGY__: {output_stream << " getEnergy__ ";break;}
		case E_DOTGETBEARING__: {output_stream << " e_DOTgetBearing__ ";break;}
		case E_DOTGETHEADING__: {output_stream << " e_DOTgetHeading__ ";break;}
		case E_DOTGETVELOCITY__: {output_stream << " e_DOTgetVelocity__ ";break;}
		case E_DOTGETENERGY__: {output_stream << " e_DOTgetEnergy__ ";break;}
		case E_DOTGETDISTANCE__: {output_stream << " e_DOTgetDistance__ ";break;}
		...
		case DIVIDED: {output_stream << " DIVIDED ";break;}
