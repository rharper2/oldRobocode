...
/*******************************************************************
                    TWOPOINTBITOPERATOR
                    choose two points within the useful dna and exchange the segments
                    delineated by them.
********************************************************************/

void cr_data::twoPointBitOperator(const crPtr &op1,const crPtr &op2,crPtr &child1,crPtr &child2) {
          ...
          long len2 = pge1->getUsefulDna(); //hmm
          if (len1 > 64000) {
          ...
          do { 
                    ...
                    long chunk1 = (randomint(len1-1 -slice1))+1;
                    long chunk2 = (randomint(len2-1 - slice2))+1;
                    if (slice1 < 1) {
                    ...
                    if (slice1 + chunk1 > len1) cout << "ERROR SLICE1 and CHUNK1 CANT EXCEED LEN!\n";
                    if (slice2 + chunk2 > len2) cout << "ERROR SLICE2 and CHUNK2 cant exceed LEN2\n";
